...
ToyCustom {
    ...
    accessoryAnnoyedMouth {
        visible: false
    }
    accessoryConfusedEyes {
    ...
    accessoryCuteEyebrows {
        x: 0.17173990607261658
        y: -3.7152304649353027
        z: -5.253482818603516
    ...
    accessorySmallEyebrows {
        x: -0.003959760535508394
        y: 0.1685100644826889
        z: -0.08624128252267838
        rotation: Qt.quaternion(0.707107, 0.707107, 0, 0)
        scale.x: 0.255459
        scale.y: 0.255458
        scale.z: 0.255459
    ...
    accessorySurprisedMouth {
        visible: false
    }
    modelWideEyes {
        x: -0.013087843544781208
        y: -0.0915747806429863
        z: -0.021830284968018532
    ...
    modelWideEyes_1 {
        y: -0.19275029003620148
        z: 1.4294742345809937
    }
    modelWideEyes_2 {
        y: -0.23832283914089203
        z: 1.429474115371704
    }
    modelWideEyes_3 {
        x: 0.004780661314725876
        y: 0.39956873655319214
        z: -0.1316821426153183
        scale.x: 0.303691
        scale.y: 0.303691
        scale.z: 0.303691
    }
    ...
    modelHeadphones {
        ...
        scale.y: 1
        scale.z: 1
        eulerRotation.z: 77.02399
        eulerRotation.y: -163.3396
        eulerRotation.x: -78.51367
    }
    modelWizardHat {
        x: -0.027
        y: 0.198
    ...
    PrincipledMaterial {
        id: pigMaterial
        normalMap: Texture { source: "images/Pig_NormalMap.png" }
        baseColorMap: Texture { source: "images/Pig_BaseColor.png" }
        objectName: "Pig.003"
        roughness: 1
