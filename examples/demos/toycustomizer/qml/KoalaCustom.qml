...
ToyCustom {
    ...
    toyNodeModel {
        source: "meshes/skin_koala.mesh"
        skin: skin
        materials: duoToneKoala
    }
    universalArmature {
    ...
    modelAnnoyedMouth {
        position: Qt.vector3d(2.75, -3.1, 2.5)
        scale.x: 6.43903
        scale.y: 6.43903
        scale.z: 6.43903
    }
    ...
    accessoryConfusedMouth {
        position: Qt.vector3d(0.05, -0.25, 0.74)
    ...
    modelCuteMouth {
        position: Qt.vector3d(2.75, -3.8, 3.2)
    ...
    modelPowerpuffMouth {
        position: Qt.vector3d(0, -0.25, -0.055)
    ...
    modelSmallMouth {
        position: Qt.vector3d(0, -0.13, -0.11)
    ...
    modelSurprisedMouth {
        position: Qt.vector3d(0.1, -3, 6.5)
    ...
    modelWideMouth {
        position: Qt.vector3d(-0.012318873777985573, -0.04, 0.8320723414421082)
    ...
    PrincipledMaterial {
        ...
        baseColorMap: Texture { source: "images/Koala_BaseColor.png" }
        normalMap: Texture { source: "images/Koala_NormalMap.png" }
    }
}
