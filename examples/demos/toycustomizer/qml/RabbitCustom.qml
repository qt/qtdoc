...
ToyCustom {
    ...
    toyNodeModel {
        source: "meshes/skin_rabbit.mesh"
        skin: skin
        materials: rabbitMaterial
    }
    universalRigged {
    ...
    accessorySmallEyes {
        x: 0.010037709958851337
        y: 0.005077500827610493
        z: -0.0018088488141074777
    ...
    PrincipledMaterial {
        id: rabbitMaterial
        normalMap: Texture { source: "images/Rabbit_NormalMap.png" }
        baseColorMap: Texture { source: "images/Rabbit_BaseColor.png" }
        roughness: 1
