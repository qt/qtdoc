...
ToyCustom {
    ...
    toyNodeModel {
        source: "meshes/skin_tiger.mesh"
        skin: skin
        materials: tigerMaterial
    }
    bodyRigged {
    ...
    modelAnnoyedMouth {
        x: 2.7009313106536865
        y: -1.1324694156646729
        z: 2.1308295726776123
        scale.x: 6.43903
        scale.y: 6.43903
        scale.z: 6.43903
    }
    ...
    accessoryConfusedMouth {
        ...
        y: 0.101
        z: 0.57057
        rotation: Qt.quaternion(0.974043, 0.219918, -0.0489586, 0.0219)
        scale.x: 0.331823
        scale.y: 0.331823
        scale.z: 0.331823
    }
    ...
    modelCuteMouth {
        ...
        y: 0.821
        z: 5.38584
        eulerRotation.z: -0.06005
        eulerRotation.y: 4.34155
        eulerRotation.x: 20.53076
        scale.z: 0.5
        scale.y: 0.5
        scale.x: 0.5
    }
    ...
    modelSmallMouth {
        x: 0.003
        y: -0.22
        eulerRotation.z: -2.85687
        eulerRotation.y: 10.05486
        eulerRotation.x: -44.78835
        z: -0.05744
        scale.z: 0.02
        scale.y: 0.02
        scale.x: 0.02
    ...
    modelSurprisedMouth {
        ...
        y: 0.279
        z: 5.95836
        eulerRotation.z: 3.71423
        eulerRotation.y: 0.07841
        eulerRotation.x: 25.28261
        scale.z: 0.33182
        scale.y: 0.33182
        scale.x: 0.33182
    }
    ...
    modelCap {
        ...
        scale.y: 0.12748
        scale.z: 0.12748
        eulerRotation.z: 59.14979
        eulerRotation.y: -54.40364
        eulerRotation.x: -68.49421
    }
    modelConeHat {
        x: -0.081
        y: 0.151
    ...
    modelHeadphones {
        ...
        y: 0.053
        z: 0.32535
        rotation: Qt.quaternion(0.500856, -0.529954, -0.521057, -0.443611)
        scale.x: 1
        scale.y: 1
        scale.z: 1
    }
    ...
    PrincipledMaterial {
        id: tigerMaterial
        normalMap: Texture { source: "images/Tiger_NormalMap.png" }
        baseColorMap: Texture { source: "images/Tiger_BaseColor.png" }
        roughness: 1
