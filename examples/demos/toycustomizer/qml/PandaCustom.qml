...
ToyCustom {
    ...
    toyNodeModel {
        source: "meshes/skin_panda.mesh"
        skin: skin
        materials: duoTonePanda
    }
    universalArmature {
    ...
    modelAnnoyedMouth {
        position: Qt.vector3d(2.75, -1, 2.5)
        scale.x: 6.43903
        scale.y: 6.43903
        scale.z: 6.43903
    }
    ...
    modelCuteMouth {
        position: Qt.vector3d(2.75, -1.4, 3)
    ...
    modelPowerpuffMouth {
        position: Qt.vector3d(0, -0.25, 0.043)
    ...
    modelSmallMouth {
        position: Qt.vector3d(0, -0.13, -0.035)
    ...
    modelSurprisedMouth {
        position: Qt.vector3d(0.1, 0.1, 6.3)
    ...
    modelWideMouth {
        position: Qt.vector3d(-0.012318873777985573, 0.4054557693004608, 0.8320723414421082)
    ...
    PrincipledMaterial {
        ...
        baseColorMap: Texture { source: "images/Panda_BaseColor.png" }
        normalMap: Texture { source: "images/Panda_NormalMap.png" }
    }
}
