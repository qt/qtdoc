...
ToyCustom {
    ...
    toyNodeModel {
        source: "meshes/skin_squirrel.mesh"
        skin: skin
        materials: squirrelMaterial
    }
    universalRigged {
    ...
    modelPowerpuffMouth {
        position: Qt.vector3d(-0.003, -0.24, 0.0685434)
    ...
    PrincipledMaterial {
        ...
        baseColorMap: Texture { source: "images/Squirrel_BaseColor.png" }
        normalMap: Texture { source: "images/Squirrel_NormalMap.png" }
    }
}
