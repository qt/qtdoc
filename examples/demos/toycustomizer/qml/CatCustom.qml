...
ToyCustom {
    ...
    accessoryConfusedMouth {
        position: Qt.vector3d(0.028, 0.045, 0.6)
    ...
    modelPowerpuffMouth {
        position: Qt.vector3d(-0.003, -0.269, 0.0685434)
    ...
    modelSmallMouth {
        position: Qt.vector3d(-0.002, -0.1999, -0.046)
    ...
    modelSurprisedMouth {
        position: Qt.vector3d(0.048, 0.096, 5.8)
    ...
    modelWideMouth {
        position: Qt.vector3d(0, 0.515, 0.76)
    ...
    PrincipledMaterial {
        ...
        baseColorMap: Texture { source: "images/Cat_BaseColor.png" }
        normalMap: Texture { source: "images/Cat_NormalMap.png" }
    }
}
