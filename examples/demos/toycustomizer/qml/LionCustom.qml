...
ToyCustom {
    ...
    toyNodeModel {
        source: "meshes/skin_lion.mesh"
        skin: skin
        materials: lionMaterial
    }
    universalArmature {
    ...
    accessoryHolderEyes {
        ...
        y: 0.34249943494796753
        z: -0.004048084374517202
        rotation: Qt.quaternion(0.718825, -0.136648, -0.681451, -0.0155715)
    }
    modelAnnoyedEyes {
        x: -0.0003483230248093605
        y: -0.025516914203763008
        z: -0.012772757560014725
    ...
    modelAnnoyedEyebrows {
        x: 0.0007747262716293335
        y: -2.0784430503845215
        z: -4.479295253753662
        scale.x: 6.43903
        scale.y: 6.43903
        scale.z: 6.43903
    ...
    modelAnnoyedMouth {
        x: 2.70093035697937
        y: -1.132468581199646
        z: 2.1308374404907227
        scale.x: 6.43903
        scale.y: 6.43903
        scale.z: 6.43903
    }
    modelConfusedEyes {
        position: Qt.vector3d(0.00287, 0.0068, -0.07)
    ...
    accessoryConfusedMouth {
        position: Qt.vector3d(0, 0.1, 0.65)
        rotation: Qt.quaternion(0.984932, 0.16482, -0.0472723, 0.0225496)
        scale: Qt.vector3d(0.6, 0.331823, 0.331823)
    }
    modelCuteEyes {
        x: 0.00262658204883337
        y: -0.003271661698818207
        z: -0.037822991609573364
        scale.x: 0.0396734
        scale.y: 0.0396735
        scale.z: 0.0396735
        eulerRotation.z: -10.28751
        eulerRotation.y: -2.81709
        eulerRotation.x: 16.47585
    }
    modelCuteEyebrows {
        x: 0.05215892195701599
        y: -3.5074923038482666
        z: -5.260934352874756
        rotation: Qt.quaternion(0.999837, 6.87797e-05, -0.0180035, 0.00130179)
        scale.x: 6.43903
        scale.y: 6.43903
        scale.z: 6.43903
    }
    ...
    modelPowerpuffEyes {
        position: Qt.vector3d(-0.002, -0.029, -0.065)
        rotation: Qt.quaternion(0.776248, -0.624027, 0.0418585, -0.0792301)
        scale: Qt.vector3d(0.85, 0.79, 0.79)
    }
    modelPowerpuffEyebrows {
        y: 0.19136035442352295
        z: -0.08120261132717133
        rotation: Qt.quaternion(0.707107, 0.707107, 0, 0)
        scale.x: 0.255459
        scale.y: 0.255459
        scale.z: 0.255459
    ...
    modelPowerpuffMouth {
        position: Qt.vector3d(-0.003, -0.3, 0.06)
        scale: Qt.vector3d(0.02, 0.02, 0.02)
        eulerRotation: Qt.vector3d(64.99998, -179.99997, -179.99998)
    }
    modelSmallEyes {
        x: 0.013645559549331665
        y: 0.014445514418184757
        z: -0.028406282886862755
        rotation: Qt.quaternion(0.710811, -0.696372, 0.0550266, -0.0823777)
    }
    modelSmallEyebrows {
        x: -0.003959749825298786
        y: 0.16850973665714264
        z: -0.08624143153429031
        rotation: Qt.quaternion(0.707107, 0.707107, 0, 0)
        scale.x: 0.255459
        scale.y: 0.255459
        scale.z: 0.255459
    ...
    modelSurprisedEyes {
        position: Qt.vector3d(0, -0.0222, -0.063)
    ...
    modelSurprisedMouth {
        position: Qt.vector3d(0.048, -0.268, 6.4)
        eulerRotation: Qt.vector3d(43.74624, 1.26713, 1.21353)
        scale: Qt.vector3d(0.6, 0.6, 0.6)
    }
    modelWideEyes {
        x: -0.012811146676540375
        y: -0.09096617251634598
        z: -0.02168007753789425
    ...
    modelWideEyes_1 {
        y: -0.19275015592575073
        z: 1.4294742345809937
    }
    modelWideEyes_2 {
        y: -0.23832258582115173
        z: 1.4294743537902832
    }
    modelWideEyes_3 {
        x: 0.00478070043027401
        y: 0.39956894516944885
        z: -0.13168218731880188
        scale.x: 0.303691
        scale.y: 0.303691
        scale.z: 0.303691
    }
    modelWideMouth {
        x: 0.02107296884059906
        y: 0.4354557693004608
        z: 0.9320723414421082
    ...
    modelMonocle {
        position: Qt.vector3d(-0.217, -0.01, 0.013)
    ...
    PrincipledMaterial {
        ...
        baseColorMap: Texture { source: "images/Lion_BaseColor.png" }
        normalMap: Texture { source: "images/Lion_NormalMap.png" }
    }
}
